...
<head>
    ...
    <title>Just4Fun - J4F Coin Node</title>
...
$miner = false;
$hashrate = 'No info';
$explorerURL = 'https://mainnet.j4f.dev/block/height/';
$isSyncing = false;
$nodeVersion = 'No info';
if ($nodeConfig != null) {
    ...
    if ($network == 'testnet')
        $explorerURL = 'https://testnet.j4f.dev/block/height/';
...
<section class="node <?= $network; ?> fh">
    <div class="node-b">
        <div class="container">
            <h1 class="title">J4F Node <small>on <?= $network; ?></small></h1>
